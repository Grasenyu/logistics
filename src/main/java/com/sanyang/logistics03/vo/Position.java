...
public String toString() {
	return "Position [posn_id=" + posn_id + ", posn_code=" + posn_code + ", shelf_id=" + shelf_id + ", wh_id=" + wh_id
			+ ", posn_no=" + posn_no + ", capacity=" + capacity + ", available_capacity=" + available_capacity
			+ ", occupy_amt=" + occupy_amt + "]";
}


public Position(Integer posn_id, String posn_code, Integer shelf_id, Integer wh_id, String posn_no, Integer capacity,
		Integer available_capacity, Integer occupy_amt) {
	super();
	this.posn_id = posn_id;
	this.posn_code = posn_code;
	this.shelf_id = shelf_id;
